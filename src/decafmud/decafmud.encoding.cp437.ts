...
(function(DecafMUDGlobal: any) { // Use a different name to avoid conflict
...
const encode = function(data: string): string {
    return data.replace(/[\u00A0-\u266B]/g, function(m: string): string { // Range might need adjustment for all Unicode chars
...
// Commenting out unused debug code
/*
...
(DecafMUDGlobal as any).plugins.Encoding.cp437 = {
    proper : 'CP437',
