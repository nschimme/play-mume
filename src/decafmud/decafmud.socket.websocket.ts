...
/** <p>This provides support for <a href="http://dev.w3.org/html5/websockets/">H
TML5 WebSockets</a>
 ...
 * @requires <a href="http://dev.w3.org/html5/websockets/#the-websocket-interfac
e">WebSocket</a>
...
DecafWebSocket.prototype.setup = function() {
        // If WebSockets are available, immediately call the socketReady event o
f
        ...
        this.decaf.error("Unable to create a WebSocket. Does your browser suppor
t them? If not, try {0}.".tr(
                this.decaf, '<a href="http://www.google.com/chrome" target="_bla
nk">Google Chrome</a>'));
}
...
;
        ...
        this.websocket.onmessage        = this.onMessage.bind(this, this.websock
et);
}
...
/** Called when the WebSocket's onOpen event fires. If the WebSocket's readyStat
e
