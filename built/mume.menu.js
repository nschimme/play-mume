...
toolbar_menus[MENU_HELP][MI_SUBMENU].push('About Map', 'mume_menu_about_map();', 'Map(per) Bug?', 'mume_menu_map_bug();');
toolbar_menus[MENU_OPTIONS][MI_SUBMENU].unshift('Detach Map', '_open_mume_map_window();');
function _mume_menu_new() {
    window.open('http://mume.org/newcomers.php', 'mume_new_players');
}
function _mume_menu_help() {
    window.open('http://mume.org/help.php', 'mume_help');
}
function _mume_menu_rules() {
    window.open('http://mume.org/rules.php', 'mume_rules');
}
function _mume_menu_about_map() {
    alert("Play MUME!, a modern web client for MUME using DecafMUD, is brought to you by Waba,\n" +
