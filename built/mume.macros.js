    ...
    if (numpad_enabled()) {
        switch (keycode) {
            ...
            case 97:
                ...
                return 1;
            case 98:
                decaf.sendInput("south");
                return 1;
            case 99:
                decaf.sendInput("kp3");
                return 1;
            case 100:
                decaf.sendInput("west");
                return 1;
            case 101:
                decaf.sendInput("kp5");
                return 1;
            case 102:
                decaf.sendInput("east");
                return 1;
            case 103:
                decaf.sendInput("kp7");
                return 1;
            case 104:
                decaf.sendInput("north");
                return 1;
            case 105:
                decaf.sendInput("kp9");
                return 1;
            case 106:
                decaf.sendInput("kpstar");
                return 1;
            case 107:
                decaf.sendInput("kpplus");
                return 1;
            case 109:
                decaf.sendInput("kpminus");
                return 1;
            case 110:
                decaf.sendInput("kpdot");
                return 1;
            case 111:
                decaf.sendInput("kpslash");
                return 1;
        }
    }
