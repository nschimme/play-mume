...
const jquery_1 = __importDefault(require("jquery")); // Assuming jQuery will be installed as a module
require("jquery-throttle-debounce"); // Assuming this is a jQuery plugin, it might need to be imported like this
...
require("../DecafMUD/src/js/decafmud.js"); // Main script for side effects (sets up global DecafMUD)
require("../DecafMUD/src/js/decafmud.display.standard.js");
require("../DecafMUD/src/js/decafmud.encoding.iso885915.js");
require("../DecafMUD/src/js/decafmud.socket.websocket.js");
require("../DecafMUD/src/js/decafmud.storage.standard.js");
require("../DecafMUD/src/js/decafmud.telopt.gmcp.js");
require("../DecafMUD/src/js/decafmud.interface.panels.js");
require("../DecafMUD/src/js/decafmud.interface.panels.menu.js");
require("../DecafMUD/src/js/decafmud.interface.panels.settings.js");
require("../DecafMUD/src/js/dragelement.js");
// Import project's own TypeScript modules
require("./errorhandler"); // Assuming errorhandler.js is compiled from a .ts file we want to include
require("./mume.macros"); // Assuming mume.macros.js is compiled from a .ts file
require("./mume.menu"); // Assuming mume.menu.js is compiled from a .ts file
const mume_mapper_1 = require("./mume.mapper"); // Corrected import from mume.mapper
...
let globalMapWindow; // Adjusted type
let _globalSplit; // Correct type for Split.js instance
let globalMap;
// This function was global, now it's part of the module scope
function canvasFitParent() {
    if (globalMapWindow != undefined && (0, jquery_1.default)('#mume-map-panel').width() >= 1) { // Added null check for width
...
(0, jquery_1.default)(window).on('load', function () {
    ...
    DecafMUD.plugins.TextInputFilter.mumexml = mume_mapper_1.MumeXmlParser;
    new DecafMUD({
        host: 'mume.org',
        port: 443,
        autoreconnect: false,
    ...
    _globalSplit = (0, split_js_1.default)(['#mume-client-panel', '#mume-map-panel'], {
        sizes: [80, 20],
        cursor: 'col-resize',
        snapOffset: 100,
        minSize: 0,
    ...
    mume_mapper_1.MumeMap.load('mume-map').done(function (map) {
        let parser; // Type correctly
        let tagEventHandler;
        if (DecafMUD.instances && DecafMUD.instances[0] && DecafMUD.instances[0].textInputFilter) {
            parser = DecafMUD.instances[0].textInputFilter; // Type assertion
            ...
            (0, jquery_1.default)(parser).on(mume_mapper_1.MumeXmlParser.SIG_TAG_END, tagEventHandler);
        ...
        if (typeof jquery_1.default.throttle === 'function') {
            (0, jquery_1.default)(window).on('resize', jquery_1.default.throttle(500, canvasFitParent));
        }
        else {
            console.warn('jQuery throttle function not found. Resize events will not be throttled.');
            (0, jquery_1.default)(window).on('resize', canvasFitParent);
        }
        canvasFitParent();
        const mumeClientPanel = (0, jquery_1.default)('#mume-client-panel');
        function handleSizeChange() {
            const isWide = mumeClientPanel.width() > 600; // Added null check
            (0, jquery_1.default)('.decafmud.display.c7').css('white-space', isWide ? 'nowrap' : 'normal');
        }
...
(0, jquery_1.default)(window).on('unload', function () {
